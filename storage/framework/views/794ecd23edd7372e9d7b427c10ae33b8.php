                ...
                <?php $__currentLoopData = $meetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-8 shadow-sm rounded-lg border border-gray-100">
                        ...
                        <div class="space-y-1 text-gray-700">
                            ...
                            <p><strong>Dia: </strong><?php echo e($meeting->day); ?> a les <?php echo e($meeting->time); ?></p>
                            <p><strong>Inscripcions: </strong><?php echo e($meeting->appDateIni); ?> fins <?php echo e($meeting->appDateEnd); ?></p>
                        ...
                        <div class="flex justify-between items-center text-sm font-medium">
                            ...
                            <form action="<?php echo e(route('meetings.destroy', $meeting->id)); ?>" method="POST" onsubmit="return confirm('Segur?')">
