                ...
                <form action="<?php echo e(route('treks.update', $trek->id)); ?>" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="regNumber" 
                               value="<?php echo e(old('regNumber', $trek->regNumber)); ?>" 
                               class="w-full rounded <?php $__errorArgs = ['regNumber'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" 
                               value="<?php echo e(old('name', $trek->name)); ?>" 
                               class="w-full rounded <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full rounded <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <option value="y" <?php echo e(old('status', $trek->status) == 'y' ? 'selected' : ''); ?>>Activa</option>
                            <option value="n" <?php echo e(old('status', $trek->status) == 'n' ? 'selected' : ''); ?>>Inactiva</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="municipality_id" class="w-full rounded <?php $__errorArgs = ['municipality_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $municipalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($municipality->id); ?>" 
                                    <?php echo e(old('municipality_id', $trek->municipality_id) == $municipality->id ? 'selected' : ''); ?>>
