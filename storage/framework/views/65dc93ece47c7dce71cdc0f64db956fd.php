...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full border-gray-300 rounded">
                            <option value="y" <?php echo e(old('status') == 'y' ? 'selected' : ''); ?>>Actiu</option>
                            <option value="n" <?php echo e(old('status') == 'n' ? 'selected' : ''); ?>>Inactiu</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block font-medium">ID Reunió</label>
                        <select name="meeting_id" class="w-full border-gray-300 rounded">
                            <?php $__currentLoopData = $meetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($meeting->id); ?>">Reunió #<?php echo e($meeting->id); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/CRUD/comment_create.blade.php ENDPATH**/ ?>