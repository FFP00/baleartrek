                ...
                @foreach ($meetings as $meeting)
                    <div class="bg-white p-8 shadow-sm rounded-lg border border-gray-100">
                        ...
                        <div class="space-y-1 text-gray-700">
                            ...
                            <p><strong>Dia: </strong>{{ $meeting->day }} a les {{ $meeting->time }}</p>
                            <p><strong>Inscripcions: </strong>{{ $meeting->appDateIni }} fins {{ $meeting->appDateEnd }}</p>
                        ...
                        <div class="flex justify-between items-center text-sm font-medium">
                            ...
                            <form action="{{ route('meetings.destroy', $meeting->id) }}" method="POST" onsubmit="return confirm('Segur?')">
                                @csrf @method('DELETE')
